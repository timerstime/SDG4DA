...
def run(path_source,path_target):
    ...
    parser.add_argument("--save", help="save model to file (appends .model as well as .pickle)",default='save_dir')
...
if __name__=="__main__":
	file1=os.listdir(root_dir)
	for file2 in file1:
		path_source=os.path.join(root_dir,file2,'source.conll')
		path_target=os.path.join(root_dir,file2,'target.conll')
		print('path_source',path_source,'path_target',path_target,)
		print('start...')
		run(path_source,path_target)
		print('path_source',path_source,'path_target',path_target,'this task end!')
