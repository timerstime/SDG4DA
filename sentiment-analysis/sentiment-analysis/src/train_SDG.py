...
# Parameters
# ==================================================
tf.flags.DEFINE_string("debug_flag",'ubuntu', "")
# Data loading params
...
tf.flags.DEFINE_integer("bag_size", 100, "size of bags for independent selection (default: 100)") #Only for non-clustering method for experiment
...
############
#Loading data, All tokenized sentences in x_text_all, all labels like [0,1] and [1,0] in y_all
