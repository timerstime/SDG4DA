...
#            for actor_epoch in range(pre_epochs_actor):
                ...
                select_train, select_label,select_num1 = globals()['actor__' + str(bag_id)].sample(tf.convert_to_tensor(state), X_train_t, y_train_t)
                state_ = globals()['actor__' + str(bag_id)].deform(W_data_t_3d)
                state_=np.squeeze(state_)
                print("squ", state_)
                select_train_, select_label_,select_num2 = globals()['actor__' + str(bag_id)].sample(tf.convert_to_tensor(state_), X_train_t, y_train_t)
                # print(select_train_)
                # print(select_label_)
                # print("*****state:", state)
